...
export const studentRegistrationForTest = async (students, history) => {
  try {
    ...
    const { data } = await httpService.post("/api/student/register", students);
    toast.success(data);
...
export const studentTestPaperList = () => async (dispatch) => {
  try {
    ...
    let { data } = await httpService.get("/api/student/alltest", Token());
